...
//! will move memo ptr, will overwrite memo if already exist at this index, need to be call
//! grdw_transaction_body_reserve_memos first
...
//! will copy memo from ptr, allocate memory for memo, need to be call
//! grdw_transaction_body_reserve_memos first
