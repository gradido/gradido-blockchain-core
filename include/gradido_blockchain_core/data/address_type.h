#ifndef GRADIDO_BLOCKCHAIN_CORE_DATA_ADDRESS_TYPE_H
#define GRADIDO_BLOCKCHAIN_CORE_DATA_ADDRESS_TYPE_H

#ifdef __cplusplus
extern "C" {
#endif

typedef enum grdd_address_type {
...
#endif // GRADIDO_BLOCKCHAIN_CORE_DATA_ADDRESS_TYPE_H
