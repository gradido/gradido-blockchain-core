#ifndef GRADIDO_BLOCKCHAIN_CORE_TYPE_LEDGER_ANCHOR_H
#define GRADIDO_BLOCKCHAIN_CORE_TYPE_LEDGER_ANCHOR_H
...
#endif /* GRADIDO_BLOCKCHAIN_CORE_TYPE_LEDGER_ANCHOR_H */
