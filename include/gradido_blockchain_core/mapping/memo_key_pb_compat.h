...
// SHARED SECRET
static_assert(
    GRDW_MEMO_KEY_TYPE_SHARED_SECRET ==
    proto_gradido_encrypted_memo_shared_secret_e,
    "MemoKeyType enum mismatch: SHARED SECRET"
);

// COMMUNITY SECRET
static_assert(
    GRDW_MEMO_KEY_TYPE_COMMUNITY_SECRET ==
    proto_gradido_encrypted_memo_community_secret_e,
    "MemoKeyType enum mismatch: COMMUNITY SECRET"
);

// PLAIN
static_assert(
    GRDW_MEMO_KEY_TYPE_PLAIN ==
    proto_gradido_encrypted_memo_plain_e,
