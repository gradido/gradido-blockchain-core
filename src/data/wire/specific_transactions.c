...
void grdw_community_root_assemble(
  ...
  memcpy(community_root->pubkey, pubkey, 32);
  memcpy(community_root->gmw_pubkey, gmw_pubkey, 32);
  memcpy(community_root->auf_pubkey, auf_pubkey, 32);
}
...
void grdw_gradido_creation_assemble(
  ...
  memcpy(gradido_creation->recipient.pubkey, recipient_pubkey, 32);
  gradido_creation->recipient.amount = amount;
  memcpy(gradido_creation->recipient.community_uuid, community_uuid, 16);
...
void grdw_gradido_transfer_assemble(
  ...
  memcpy(gradido_transfer->sender.pubkey, sender_pubkey, 32);
  gradido_transfer->sender.amount = amount;
  memcpy(gradido_transfer->sender.community_uuid, community_uuid, 16);
  memcpy(gradido_transfer->recipient, recipient_pubkey, 32);
}
...
void grdw_gradido_deferred_transfer_assemble(
  ...
  memcpy(gradido_deferred_transfer->transfer.sender.pubkey, sender_pubkey, 32);
  gradido_deferred_transfer->transfer.sender.amount = amount;
  memcpy(gradido_deferred_transfer->transfer.sender.community_uuid, community_uuid, 16);
  memcpy(gradido_deferred_transfer->transfer.recipient, recipient_pubkey, 32);
...
void grdw_gradido_redeem_deferred_transfer_assemble(
  ...
  memcpy(gradido_redeem_deferred_transfer->transfer.sender.pubkey, sender_pubkey, 32);
  gradido_redeem_deferred_transfer->transfer.sender.amount = amount;
  memcpy(gradido_redeem_deferred_transfer->transfer.sender.community_uuid, community_uuid, 16);
  memcpy(gradido_redeem_deferred_transfer->transfer.recipient, recipient_pubkey, 32);
}
