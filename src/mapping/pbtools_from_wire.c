 ...
 * simply copy ptr to dst, or do nothing if at least one parameter is NULL
 */
static void memory_block_from_wire(struct pbtools_bytes_t *dst, const hostmem_memory_block *bytes) {
...
static hostmem_result hiero_transaction_id_from_wire(
...
static hostmem_result ledger_anchor_from_wire(
...
static hostmem_result community_friends_update_from_wire(
...
static hostmem_result community_root_from_wire(
...
static hostmem_result gradido_creation_from_wire(
...
static hostmem_result gradido_transfer_from_wire(
...
static hostmem_result gradido_deferred_transfer_from_wire(
...
static hostmem_result gradido_redeem_deferred_transfer_from_wire(
...
static hostmem_result gradido_timeout_deferred_transfer_from_wire(
...
static hostmem_result register_address_from_wire(
...
hostmem_result grdm_transaction_body_from_wire(
  ...
  if (!transaction_body || !pb_transaction_body) { return HOSTMEM_ERROR_NULL_POINTER; }
...
hostmem_result grdm_confirmed_transaction_from_wire(
  ...
  if (!confirmed_tx || !pb_confirmed_tx) { return HOSTMEM_ERROR_NULL_POINTER; }
